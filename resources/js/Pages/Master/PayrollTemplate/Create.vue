...
<template>
    <Head title="Tambah Template Gaji" />
                ...
                <div class="overflow-hidden bg-white shadow-sm sm:rounded-lg p-8">
                    <form @submit.prevent="submit">
                        ...
                        <div class="border-t pt-6">
                            ...
                            <p class="text-sm text-gray-500 mb-4">Centang komponen-komponen yang akan secara otomatis masuk ke dalam cetakan gaji karyawan dengan template ini.</p>
                            ...
                            <div v-if="components.length === 0" class="text-sm text-red-500">
                                Belum ada daftar Komponen Gaji yang aktif di sistem.
                            </div>
                        </div>
