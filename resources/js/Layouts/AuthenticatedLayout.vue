                            ...
                            >
                                ...
                                <div class="hidden sm:flex sm:items-center sm:ms-6" v-if="$page.props.auth.user.permissions.includes('view-master-data')">
                                    <Dropdown align="right" width="48">
                                        ...
                                        <template #content>
                                            <DropdownLink :href="route('branches.index')">Cabang</DropdownLink>
                                            <DropdownLink :href="route('departments.index')">Departemen</DropdownLink>
                                            <DropdownLink :href="route('positions.index')">Jabatan</DropdownLink>
                                            <DropdownLink :href="route('payroll-components.index')">Komponen Gaji</DropdownLink>
                                ...
                                <!-- Settings Dropdown -->
                                <div class="hidden sm:flex sm:items-center sm:ms-6" v-if="$page.props.auth.user.roles.includes('HR Admin')">
                                    <Dropdown align="right" width="48">
                                        <template #trigger>
                                            <span class="inline-flex rounded-md pt-5">
                                                <button
                                        ...
                                        <template #content>
                                            ...
                                            <div class="border-t border-gray-100"></div>
                                            <DropdownLink :href="route('permissions.index')">Kunci Basis Sistem</DropdownLink>
                                        </template>
                                    </Dropdown>
                                </div>
